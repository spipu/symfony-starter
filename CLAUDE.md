...
`.depfile.mvc.yaml` validates MVC separation. Layers: Command, Controller, Entity, Form, Repository, Service (includes Fixture and Twig), Step, Ui, Validator. Uses new deptrac format (`type: classLike`). Violations will fail `./quality/deptrac.sh`.
